#pragma once
/*
        multivector -- A vector with iterators that are vectors too.
        Licensed under the MIT License <http://opensource.org/licenses/MIT>.
        Copyright (c) 2016-2019 Mark Beckwith <http://github.com/wythe>
*/
#include <exception>
#include <functional>
#include <sstream>
...
template <typename ValueType, bool is_const_cursor> struct precursor_base;
...
struct precursor_base
    ...
    bool operator==(const_precursor_reference it) const {
        return it_ == it.it_;
    }
